...
if (round_number == 1){converted_coach_index = 4;}
...
class GameScene extends Phaser.Scene {
    ...
    preload ()
    {
        ...
        this.load.tilemapCSV('map', '../static/assets/tilemaps/csv/minecraft_tilemap_2_second_map_w_border_mod.csv');
...
//                    tile.tint = 0x404040
    ...
    create_victim_groups = function() {
        ...
        this.yellow_victims.create(5*64+32, 6*64+32, 'yellow_victim');
        this.yellow_victims.create(91*64+32, 7*64+32, 'yellow_victim');
        this.yellow_victims.create( 53*64+32,14*64+32, 'yellow_victim');
        this.yellow_victims.create( 24*64+32, 19*64+32, 'yellow_victim');
        this.yellow_victims.create(72*64+32, 28*64+32, 'yellow_victim');
        this.yellow_victims.create( 76*64+32, 35*64+32,'yellow_victim');
        this.yellow_victims.create( 32*64+32, 44*64+32,'yellow_victim');
        this.yellow_victims.create(6*64+32, 46*64+32, 'yellow_victim');

        this.green_victims = this.physics.add.group({
            key: "green_victims",
        });

        this.green_victims.create( 18*64+32, 2*64+32, 'green_victim');
        this.green_victims.create( 40*64+32, 2*64+32,'green_victim');
        this.green_victims.create( 64*64+32, 3*64+32,'green_victim');
        this.green_victims.create( 24*64+32, 7*64+32,'green_victim');
        this.green_victims.create( 71*64+32, 7*64+32, 'green_victim');
        this.green_victims.create( 2*64+32, 18*64+32,'green_victim');
        this.green_victims.create( 49*64+32, 20*64+32,'green_victim');
        this.green_victims.create( 56*64+32, 22*64+32,'green_victim');
        this.green_victims.create( 79*64+32, 22*64+32,'green_victim');
        this.green_victims.create( 4*64+32, 28*64+32,'green_victim');
        this.green_victims.create( 31*64+32, 31*64+32,'green_victim');
        this.green_victims.create( 46*64+32, 32*64+32,'green_victim');
        this.green_victims.create( 71*64+32,36*64+32, 'green_victim');
        this.green_victims.create( 23*64+32, 41*64+32, 'green_victim');
    }
