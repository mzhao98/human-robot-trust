...
function writeData(data){
    var data = {"userid": "testing", "episode":0, "saving_bool":"in_progress",
                    "victim_pos":"test",
                      "num_step":1, "time_spent":1, "trajectory":"test", "advice_message":"test", "condition":2,
                      "player_score":1, "quiz_score":1, "survey_key":"test"};
  const dataOptions = {
    method: 'POST',
    headers: {
