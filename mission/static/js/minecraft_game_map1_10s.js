...
var advice = 'Instructor: Get ready to start game! Follow my navigation instructions to reach as many victims as possible. First, proceed forward.';
...
//        graphics.strokeRoundedRect(595, 5, 180, 100, { tl: 0, tr: 0, bl: 0, br: 0 });
        graphics.lineStyle(20, 0x00D8D8, 1);
        graphics.strokeRoundedRect(600, 5, 295, 170, { tl: 0, tr: 0, bl: 0, br: 0 });

        //  Our Text object to display the Score
        let info = this.add.text(50, 50, 'Score: 0', { font: '22px Arial', fill: '#ffffff' });
        let advice_text = this.add.text(50, 100, advice, { font: '28px Arial', fill: '#00FF00' ,
...
//        let curr_room_display = this.add.text(600, 130, current_room, { font: '24px Arial', fill: '#81d4fa', wordWrap: { width: 150, useAdvancedWrap: true }},);
        let curr_room_display = this.add.text(700, 200, current_room, { font: '24px Arial', fill: '#81d4fa', wordWrap: { width: 150, useAdvancedWrap: true }},);

        timer_text = this.add.text(250, 50, 'GAME BEGINS IN : 10',{ font: '24px Arial', fill: '#ffffff' });
...
//            var advice_msg_text = document.getElementById('advice_text')
            ...
            if ((initialTime <= 120) && (initialTime >= 115)){
                advice_text.setText("Instructor: 2 Minutes up, RED victim all expired. Recalculating path."+event.data);
            }
